...
class _MyDateTimeState extends State<MyDateTime> {
  ...
  showSnack(text) {
    dateTimeKey.currentState.showSnackBar(SnackBar(
                        ...
                        RaisedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (!past) {
                              ...
                              {
                                showSnack("Time cannot be past time");
                                setState(() {
                                  _time = "Not Set";
                                });
                              }
                            ...
                            child: FlatButton.icon(
                                onPressed: () async {
                                  ...
                                  if (_date != 'Not Set' &&
                                    ...
                                    showSnack('Please fill the fields');
                                  }
                                },
                                icon: Icon(
                                  Icons.add_circle,
                                  ...
                                  onPressed: () async {
                                    if (meets.length != 0) {
                                      if (price.text.toString() != '') {
                                        ...
                                        showSnack('Please enter your cost');
                                    } else
                                      showSnack('Please add a meeting');
                                  },
                                  color: Theme.of(context).primaryColor,
                                  child: Text(
                                    'Done',
